                ...
                <div class="container-fluid mt-3">
                    <div class="row flex-column flex-lg-row">
                        <div class="col mb-3">
                            ...
                            <table class="table table-striped">
                                ...
                                <?php foreach ($users as $user) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="customer_edit.php?id=<?= $user->id ?>" class="btn btn-outline-warning btn-sm">Edit</a>
                            ...
                            <a href="customer_create.php" class="btn btn-outline-danger btn-sm">Create</a>
