                                ...
                                <?php foreach ($drivers as $driver) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="./actions/driver_delete.php?id=<?= $driver->id ?>" class="btn btn-outline-danger btn-sm">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>

                            </table>
                            <a href="driver_create.php" class="btn btn-outline-danger btn-sm">Create</a>
